...
- `https://inori.ai/` 在 2026-09-01 22:30 CST 左右返回 HTTP 301，`Location: https://x.com/inori_hub`。这支持“当前域名导航到 X/Twitter 账号”的描述；账号历史和归属仍需人工核验。
...
论文正文中使用“截至 2026-09-01 核查”“公开页面显示”等限定语。对社群转述、玩家视频简介和小红书笔记，先作为线索；只有经过原始公告、作者确认或多源交叉验证后，才升级为时间线事实。所有平台指标注明采集日期。
